...
<%
    ...
    if (bidCeil < bidVal) {
        out.println("<div class=\"container signin\"><p>Your bid ceiling cannot be less than your bid. Please go back and edit your auto-bid<br><br><a href=\"auctionList.jsp\">Return to listings</a>.</p> </div>");
    } else {
